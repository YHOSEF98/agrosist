            ...
            <div class="container-fluid" bis_skin_checked="1">
                <div class="card" bis_skin_checked="1">
                    <div class="card-header" bis_skin_checked="1">
                        <h3 class="card-title">Listado de fincas</h3>
                    ...
                    <div class="card-body" bis_skin_checked="1">
                        <div class="d-flex gap-2 mb-3" bis_skin_checked="1">
                            ...
                            <a href="{{ route('finca-create') }}" id="print-table" type="button"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('finca-edit', $finca->id) }}" type="button"
                                                ...
                                                <form action="{{ route('finca-destroy', $finca->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                                        onclick="return confirm('¿Estás completamente seguro de eliminar la Finca «{{ $finca->nombre }}»? Esta acción no se puede deshacer.');">

                ...
                <div class="card" bis_skin_checked="1">
                    ...
                    <div class="card-body" bis_skin_checked="1">
                        <div class="d-flex gap-2 mb-3" bis_skin_checked="1">
                            ...
                            <a href="{{ route('cargos.create') }}" id="print-table" type="button"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <a href="{{ route('cargos.edit', $cargo->id) }}" type="button"
                                                ...
                                                <form action="{{ route('cargos.destroy', $cargo->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                                        onclick="return confirm('¿Estás completamente seguro de eliminar el cargo «{{ $cargo->nombre }}»? Esta acción no se puede deshacer.');">
